...
const AddTransactionView = (props) => {
  ...
  return (
    <AddTransactionContainer isAddTxnVisible={props.isAddTxnVisible} className={props.isAddTxnVisible ? "addTransactionContainernFlex" : "addTransactionContainernNone"} >
      <input
        placeholder="Amount"
        type="number"
        value={amount}
